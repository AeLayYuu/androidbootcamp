...
class _HomePageState extends State<HomePage> {
  Future<List<News>> getNews() async {
    var data = await http.get(
        'http://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=5bb4015b85d448989fce66f1bd60de66');
        ...
        child: Column(
          children: [
            Stack(children: [
              Container(
                child:
                    Image.network('${this.news.urlToImage}', fit: BoxFit.fill),
              ),
              AppBar(
